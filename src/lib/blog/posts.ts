...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "PutWatermark isn't just for adding a watermark — trim clips, blur sensitive footage, merge multiple videos, add captions, and control exactly when your watermark appears, all in your browser.",
    image: "/Crop.png",
...
export const watermarkVisibilityTimingFaqSchema = [
  ...
  },
  {
    ...
    answer:
      "Static, always-on watermarks are simpler to build. A timeline-based visibility control means tracking exactly when a watermark should render frame-by-frame, rather than overlaying it uniformly across the whole export — a detail that usually only shows up in dedicated video editing software.",
  },
  {
